...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Drinks to help with a better-for-you approach" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "SUNRISE Lander" },
      { property: "og:description", content: "Drinks to help with a better-for-you approach" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "SUNRISE Lander" },
      { name: "twitter:description", content: "Drinks to help with a better-for-you approach" },
